...
const MiniMap = ({ dragging }: { dragging: boolean }) => {
  ...
  return (
    <div
      className="absolute right-10 top-10 z-30 overflow-hidden rounded-xl shadow-soft bg-white border border-border"
      style={{
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-0 left-0 cursor-grab rounded-lg border-4 border-primary bg-primary/10"
        style={{
          width: width / divider,
