...
const MoveImage = () => {
  ...
  return (
    ...
    >
      <div className="flex gap-3 mb-2 p-2 bg-white/90 rounded-xl shadow-soft border border-border items-center justify-center">
        <button
        ...
        <button
          className="btn-icon bg-accent text-white"
      ...
      <img
        className="pointer-events-none rounded-xl shadow-soft border border-border"
        alt="image to place"
